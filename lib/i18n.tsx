...
const translations: Record<string, string> = {
  ...
  "profile.srImportHint": "Alter ONEXIS-Stundenrapport (.xlsx oder .csv), ein Kunde/Monat pro Datei, mit Tages-/Projektzeilen (Datum, Kürzel, Projekt, Tasks, Std). Fehlende Kunden/Projekte werden beim Import angelegt.",
