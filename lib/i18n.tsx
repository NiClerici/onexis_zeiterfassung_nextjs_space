...
const translations: Record<string, string> = {
  ...
  "profile.srImport": "Stundenrapport importieren (mit Projekten)",
  "profile.srImportHint": "Alter ONEXIS-Stundenrapport (.xlsx oder .csv), mehrere Dateien und/oder Blätter pro Datei möglich (z.B. ein Blatt pro Monat), mit Tages-/Projektzeilen (Datum, Kürzel, Projekt, Tasks, Std). Fehlende Kunden/Projekte werden beim Import angelegt.",
  "profile.srImportCustomerLabel": "Kunde",
  "profile.srImportCustomerPlaceholder": "wird aus der Datei vorgeschlagen",
  "profile.srImportCustomerHint": "Überschreibt den Kundennamen für ALLE ausgewählten Dateien/Blätter — nur setzen, wenn sie alle demselben Kunden gehören.",
  "profile.srImportNewCustomer": "Neuer Kunde wird angelegt: {name}",
  "profile.srImportExistingCustomer": "Bestehender Kunde: {name}",
  "profile.srImportNewProjects": "Neue Projekte werden angelegt: {names}",
  "profile.srImportCommit": "{count} Zeilen importieren",
  "profile.srImportDone": "{count} Zeilen importiert.",
