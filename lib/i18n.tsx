...
const translations: Record<string, string> = {
  ...
  // Verlaufsdiagramm rechts in der Überstunden-Hero-Karte.
  "analytics.overtimeTrendDay": "Verlauf pro Tag",
  "analytics.overtimeTrendWeek": "Verlauf pro Woche",
  "analytics.overtimeTrendMonth": "Verlauf pro Monat",
  "analytics.trendBalance": "Saldo",
  "analytics.trendStart": "Stand per {date}",
  "analytics.trendWeekUntil": "Woche bis {date}",
  "analytics.trendDeltaDay": "Tag",
  "analytics.trendDeltaWeek": "Woche",
  "analytics.trendDeltaMonth": "Monat",
